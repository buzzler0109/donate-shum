      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="relative z-10 flex-1 flex flex-col justify-center items-center py-8 px-4 sm:px-8">
          <div className="w-full max-w-4xl flex flex-col items-center text-center">
            ...
            {/* Description */}
            <p className="text-[#6B6B6B] text-[13px] md:text-[14px] max-w-[400px] leading-[1.6] mb-6">
              Шум — це розвідувальна спільнота, що застосовує аналітичні методи та працює з відкритими джерелами для збору, обробки інформації й виявлення цілей в інтересах Сил оборони України.
            </p>
